...
for cfg in tla/EPaxosConfigChainTransitionRetry.cfg; do
...
for cfg in tla/EPaxosConfigChainRecoveryLostResponseRetry.cfg; do
  run_tlc tla/EPaxosConfigChainRecoveryLostResponseRetry.tla "$cfg"
done

for cfg in tla/EPaxosConfigTransitionDedup.cfg; do
  run_tlc tla/EPaxosConfigTransitionDedup.tla "$cfg"
done

for cfg in tla/EPaxosConfigTransitionRetry.cfg; do
...
for cfg in tla/EPaxosConfigRecovery.cfg; do
  run_tlc tla/EPaxosConfigRecovery.tla "$cfg"
done

for cfg in tla/EPaxosConfigRecoveryDedup.cfg; do
