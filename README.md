...
- [docs/operations](docs/operations) contains service, lifecycle, and incident procedures.
...
- Retention and checkpoint features provide bounded operational behavior; certified protocol-state compaction, target deployment, target capacity, target data lifecycle, and signed incident evidence remain governed by [RELEASE_SCOPE.md](RELEASE_SCOPE.md).
