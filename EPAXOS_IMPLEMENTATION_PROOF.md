...
- Additional finite coverage now includes one add-then-remove normal old/mid transition retry-timer slice; arbitrary retry histories, message loss, joint consensus, arbitrary membership histories, durable replay, and unbounded proof remain open.
- Additional finite coverage now includes one add-then-remove normal old/mid transition explicit lost-response-before-retry slice; arbitrary message loss, arbitrary retry histories, joint consensus, arbitrary membership histories, durable replay, and unbounded proof remain open.
