...
| `tla/EPaxosVoterBootstrap.tla` | Certified voter-bootstrap state, seal/fence, target readiness, activation/abort, crash-prefix, and finite fairness obligations. | A RawNode refinement-trace workflow or a checked Go-to-TLA action simulation theorem. |
