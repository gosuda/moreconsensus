...
- The local Jepsen run uses in-process loopback deployment without SSH-managed OS faults; its transaction coverage is a simple two-key atomic write/scan workload rather than a broad application workload.
